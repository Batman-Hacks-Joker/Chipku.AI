...
const EMOJIS = ["😊", "🥴", "💋", "🤤", "😂", "👍", "😠", "🥳", "🔥", "🥺", "🧡", "😉", "🥱", "🤓", "😈", "😍", "🤪", "🥰", "😘", "😎", "👻", "😏", "😡", "💖", "👀", "😤", "😆", "✨", "🤭", "🧐", "😪", "😒", "(ó﹏ò｡)", "⎛⎝( ` ᢍ ´ )⎠⎞ᵐᵘʰᵃʰᵃ", "(づ๑•ᴗ•๑)づ♥︎", "ಥ﹏ಥ", "( ˶˘ ³˘(ˊᗜˋ*)!♥︎", "- ̗̀( ˶'ᵕ'˶)  ̖́-", "ヽ༼ ͡☉ ͜ʖ ͡☉ ༽ﾉ", "(っ´ཀ`)っ", "ଘ(੭*ˊᵕˋ)੭* ੈ♥︎‧₊˚", "( -_•)╦̵̵̿╤─", "( ͡° ͜ʖ ͡°)", "(◍•ᴗ•◍)", ">⩊<", "(˚ ˃̣̣̥⌓˂̣̣̥  )づ♥︎", "ε(´｡•᎑•`)っ 💕", "ʰᵘʰ (ꐦ○_○）✧", "(ﾉಥ益ಥ", "(ᓀ‸ᓂ)", "( ｡ •̀ ᴖ •́ ｡)💢", "૮(˶╥︿╥)ა", ".·°՞(¯□¯)՞°·.", "(っ˶ ˘ ᵕ˘)ˆᵕ ˆ˶ς)", "₍^. .^₎Ⳋ", "૮₍ ˶ᵔ ᵕ ᵔ˶ ₎ა", "٩(ˊᗜˋ*)و ♥︎", "(∩^o^)⊃━☆.*", "(~♥︎ω♥︎~)", "o(｀ω´)o", "ദ്ദി(•̀ ᗜ<)", "₍₍⚞(˶˃ᗜ˂˶)⚟⁾⁾", "(˶°ㅁ°)!!"];
