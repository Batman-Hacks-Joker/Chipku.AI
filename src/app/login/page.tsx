...
const GoogleIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48 48" {...props}>
    ...
    <path
      fill="#1976D2"
      d="M43.611 20.083H42V20H24v8h11.303c-.792 2.237-2.231 4.166-4.087 5.571l6.19 5.238C42.012 35.816 44 30.138 44 24c0-1.341-.138-2.65-.389-3.917z"
    />
  </svg>
);
...
const LoginPage: React.FC = () => {
  ...
  return (
    <>
      <div className="min-h-screen flex items-center justify-center bg-[#F3D5E2] dark:bg-gray-900 px-6 sm:px-12 lg:px-24 font-body">
        <style jsx global>{`
          ...
          .running-emoji-wrapper {
            position: absolute;
            animation: emoji-movement 8s linear infinite;
          }
        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-3xl shadow-2xl">
            ...
            <form className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full bg-[#C21E56] hover:bg-opacity-90 text-white font-bold py-3 rounded-xl text-base transition-transform transform hover:scale-105"
              >
                Get Started
              </Button>
            </form>
