...
import { SlidersHorizontal, LayoutGrid, BookImage, CircleUserRound } from 'lucide-react';
...
const TemplatesIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M5 8H13" stroke="#0D0D0D" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M17 8H19" stroke="#0D0D0D" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M5 16H11" stroke="#0D0D0D" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M15 16H19" stroke="#0D0D0D" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M13 5L14.0607 7.06066L16.1213 8.12132L14.0607 9.18198L13 11.2426L11.9393 9.18198L9.87868 8.12132L11.9393 7.06066L13 5Z" stroke="#0D0D0D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M15 13L16.0607 15.0607L18.1213 16.1213L16.0607 17.182L15 19.2426L13.9393 17.182L11.8787 16.1213L13.9393 15.0607L15 13Z" stroke="#0D0D0D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
    ...
    <div className="min-h-screen bg-[#F7F9F9] dark:bg-[#0D0D0D] text-[#0D0D0D] dark:text-[#F7F9F9] font-sans">
      <div className="max-w-7xl mx-auto px-8 py-12">
        ...
        <header className="flex justify-between items-start mb-16">
          <div>
            <h1 className="text-5xl font-bold text-[#0A2E29] dark:text-[#E0F2F1]">Hello Abo!</h1>
